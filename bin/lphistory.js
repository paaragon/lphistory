...
yargs.scriptName('lphistory')
  .command('search [conversationid]', 'Search conversation', (args) => {
    args.positional('conversationid', {
      type: 'string',
  ...
  .command('config [action]', 'Clear configuration (it is posible to specify the envionment)', (args) => {
